...
from pysurv.adjustment import RobustMethodManager
...
def test_init_obs_method() -> None:
    ...
    method_manager = RobustMethodManager(observations="huber")
...
def test_init_free_adj_method() -> None:
    ...
    method_manager = RobustMethodManager(free_adjustment="tukey")
...
def test_ivalid_obs_method() -> None:
    ...
    with pytest.raises(InvalidMethodError):
        RobustMethodManager(observations="invalid_method")


def test_ivalid_free_method() -> None:
    """Test invalid free adjustment method raises error."""
    with pytest.raises(InvalidMethodError):
        RobustMethodManager(free_adjustment="invalid_method")
...
def test_cra_method_tuning_constants_before_injection() -> None:
    ...
    method_manager = RobustMethodManager(observations="cra")
...
def test_t_method_tuning_constants_before_injection() -> None:
    ...
    method_manager = RobustMethodManager(observations="t")
